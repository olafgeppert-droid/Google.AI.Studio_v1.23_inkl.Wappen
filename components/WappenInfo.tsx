                    ...
                    <div className="bg-[#FDF5E6] p-8 sm:p-12 rounded-lg font-serif text-lg text-stone-800 leading-relaxed">
                        ...
                        <div className="flex justify-center mb-8">
                            <img 
                                ...
                                className="max-w-xs sm:max-w-sm md:max-w-md shadow-xl rounded-lg"
                            />
                        </div>
                        ...
                        <div className="space-y-6 text-justify">
                            ...
                            <p>
                                 <DropCap>D</DropCap>ie Devise unterhalb des Wappens lautet „Memento Radicum Tuarum“, lateinisch für „Erinnere dich an deine Wurzeln“. 
                                 Der Wahlspruch fordert die Familienmitglieder auf, sich ihre Familienwurzeln zu vergegenwärtigen und zusammenzuhalten, wo immer ihr Lebensweg sie hinträgt.
                            </p>
                        </div>
